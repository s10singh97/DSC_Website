...
export default class Contact extends Component {
  ...
  handleClick = () => {
    ...
    Axios.post('/feedback', this.state.feedback).then(() => {
      this.handleSuccess()
    }).catch((err) => {
      console.log(err)
      this.handleFail()
      ...
      <div>
        ...
        <div className="green-900 containers-padding">
          <div className="input-container">
            ...
            <input value={this.state.feedback.name} placeholder="Ex: John Wick" type="text" id="name" className="margin-bottom text-field" onChange={(e) => this.handleChange(e)} />
          </div>
          ...
          <div className="input-container margin-bottom">
            ...
            <input value={this.state.feedback.email} placeholder="Ex: johnwick@gmail.com" type="email" id="email" className="margin-bottom text-field" onChange={(e) => this.handleChange(e)} />
          </div>
          <div className="small-hz-divider white" />
          <div className="input-container margin-bottom">
            <div className="fancy-title white-text margin-bottom align-center">Your Message/Feedback</div>
            <textarea value={this.state.feedback.message} rows={8} placeholder="Have a good day" id="message" onChange={(e) => this.handleChange(e)} className="text-field" />          </div>
          <div className="small-hz-divider white" />
